  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" action="{{ route('admin.create-link')}}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="box-body">
            <div class="form-group">
              <label for="nama_link" class="col-sm-2 control-label">Nama Link</label>
              <div class="col-sm-10">
                <input class="form-control" type="text" name="nama_link">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select class="form-control" name="id_kategori">
                  ...
                  <option value="{{ $kL->id }}">{{ $kL->nama_kategori }}</option>
                  @endforeach
                </select>
              </div>
            </div>
