    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="{{ route('create.limitberita')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
                        <div class="form-group">
                            <label for="limit_berita" class="col-sm-2 control-label">Limit Berita</label>
                            <div class="col-sm-10">
                                <input class="form-control" placeholder="Limit Berita" type="text" name="limit_berita">
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
