        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools" style="width: 150px;">
              <form method="get" action="{{ route('risalah.search') }}">
          ...
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
              ...
              <tr>
                <td>{!! \App\Helpers\Helper::highlight($r->deskripsi, $key ?? '') !!}</td>
                <td>@if ($r -> aktif == 1)
                ...
                <td>
                  <a href="{{ route('admin.edit-risalah', $r->id)}}" data-placement="top" data-toggle="tooltip" type="button" data-original-title="Edit" class="btn btn-xs tooltips btn-info">
                    <i class="fa fa-pencil"></i>
                  </a>
                  <form action="{{ route('admin.delete-risalah', $r->id) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
                  ...
                  <form action="{{ route('risalah.toggleAktif', $r->id) }}" method="POST" style="display:inline;">
                    @csrf
          ...
          <div class="box-footer clearfix">
            <div class="col-md-6">
              Menampilkan {{$risalah->count()}} data dari total {{$risalah->total()}} data
            </div>
            <div class="col-md-6 text-right">
              {{ $risalah->links('vendor.pagination') }}
            </div>
          </div>
        </div>
        <!-- /.box -->
