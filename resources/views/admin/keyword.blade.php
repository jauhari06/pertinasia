				...
				<div class="box">
					<div class="box-header">
						<div class="box-title">
							<div class="col-md-12">
								<div class="btn-group">
									<a href="{{ route('admin.create-keyword')}}" class="btn btn-primary" id="btn-add" data-placement="top" data-toggle="tooltip" data-original-title="Tambah"><i class="fa fa-plus"></i></a>
								</div>
								<div class="btn-group">
                  ...
                  <div class="input-group input-group-sm">
					...
					<div class="box-body table-responsive no-padding">
						<table class="table table-hover">
							...
							<tr>
								<td>{!! \App\Helpers\Helper::highlight($k->teks,$key ?? '')!!}</td>
								<td> @if ($k -> aktif == 1)
								...
								<td>
									<a href="{{ route('edit.keyword', $k->id)}}" data-placement="top" data-toggle="tooltip" type="button" data-original-title="Edit" class="btn btn-xs tooltips btn-info">
										<i class="fa fa-pencil"></i>
									</a>
									<form action="{{ route('keyword.delete', $k->id) }}" method="POST" style="display:inline;">
										@csrf
										@method('DELETE')
									...
									<form action="{{ route('keyword.toggleAktif', $k->id) }}" method="POST" style="display:inline;">
										@csrf
					...
					<div class="box-footer clearfix">
						<div class="col-md-6">
							Menampilkan {{$keyword->count()}} data dari total {{$keyword->total()}} data
						</div>
						<div class="col-md-6 text-right">
							{{ $keyword->links('vendor.pagination') }}
						</div>
					</div>
